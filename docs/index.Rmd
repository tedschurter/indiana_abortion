...
date:   "<span style = 'font-size: 13px'>June 22, 2023 </span>"
output:
  html_document:
...
```{r create_plot, fig.width=10, fig.height=6}
# assign plot to p 
...
```{r, calculate percents, plot pct cng mean, fig.width=10, fig.height=5.3}
...
```{r faceted month by year, fig.width=10, fig.height=5.3}
# set order of months
mnth$month <- factor(mnth$month, levels = c(
  "January", "February", "March", "April", "May", "June", "July","August",
  "September", "October", "November", "December"))
...
```{r abortion by mother age, year, fig.width=10}
ggplot(ab_age) + 
...
### Chart
```{r create line chart, fig.width=10, fig.height=5.75}
# create line chart ####
...
```{r facility count by year, fig.width=10}
...
```{r hospital count by year, fig.width=10}
ggplot()+
