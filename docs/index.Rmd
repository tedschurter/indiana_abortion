...
Abortion by month {data-navmenu="Charts"}
===================================== 
...
```{r, calculate percents, make plot showing pct change from mean}
  ...
  geom_textbox(data = mnth %>% 
    ...
    label = paste0("<span style = 'color:",h_avgc,"'>**September**</span> 
                was", 
                   ...
                   "% below its annual average in 2019."),
    label.colour = NA, fill = panel_c,
...
Abortion by month and year {data-navmenu="Charts"}
===================================== 

```{r faceted month by year}
...
Abortion totals by month {data-navmenu="Explore the data"}
=====================================  
Column {data-width=600}
------------------------------------------------------------------------
...
mnth %>% 
datatable(colnames = c("Year", "Month", "Resident", "Non-resident"),
  caption = htmltools::tags$caption(
          style = 'caption-side: top; text-align: center;',
    "Abortion totals by month 2014 to 2021.", style = "color:black"),
          rownames=FALSE, 
          filter = "top", 
          extensions = c('Buttons', 'FixedColumns'),
          options = list(pageLength=10, 
